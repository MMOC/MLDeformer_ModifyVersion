...
class DeformerMainWindow(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        _, self.generator_settings_controller_probability_widget = QtHelpers.add_int_field(
            ...
            min_label_text_width=self.min_label_text_width)
        _, self.generator_settings_Visibility_widget = QtHelpers.add_int_field(
            layout=self.generator_grid_layout,
            row_index=4,
            name='Visibility:',
        ...
        self.generator_settings_Visibility_widget.valueChanged.connect(self.on_generator_settings_Visibility_changed)
    ...
    def on_generator_settings_Visibility_changed(self):
        self.event_handler.generator_config.Visibility = self.generator_settings_Visibility_widget.value()
    ...
    def update_ui_widgets(self):
        ...
        # Modify
        self.generator_settings_Visibility_widget.setValue(config.Visibility)
